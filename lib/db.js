...
-- Translation cache (v0.33.175+)
-- Stores per-template, per-language translated HTML so translation only
-- runs once per template version per language. content_hash is a SHA-256
-- prefix of the source HTML — changes when the template is edited,
-- automatically invalidating the cached translation.
...
const configMigrations = [
  ...
  // Debug / diagnostics settings (v0.33.194+)
  // Both default off — clean viewer UI for regular visitors.
  // debug_overlay_enabled: enables the sync debug overlay for all visitors (equiv to ?debug=1).
  // player_stats_enabled: shows the drift/calibration readout in the player bar's status line.
  ['debug_overlay_enabled',   'INTEGER DEFAULT 0'],
  ['player_stats_enabled',    'INTEGER DEFAULT 0'],
  // Translation settings (v0.33.175+)
  ['translation_enabled',     'INTEGER DEFAULT 0'],     // 1 = translate viewer pages
  ['translation_backend',     "TEXT DEFAULT 'mymemory'"],      // 'mymemory', 'libretranslate', or 'deepl'
  ['translation_api_url',     "TEXT DEFAULT 'https://libretranslate.com'"], // LibreTranslate endpoint
  ['translation_api_key',     'TEXT'],                  // optional API key
];
